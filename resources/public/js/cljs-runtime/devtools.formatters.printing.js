...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12848){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12849,G__12850,seq12848__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12897_SHARP_){
return (!((cljs.core.meta(p1__12897_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12922__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12923){var _e__12188__auto__ = e12923;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e12928){var _e__12188__auto__ = e12928;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12934 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12935 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12935);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12937__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12934);
}});
...
var temp__5802__auto___13015 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___13015)){
var managed_print_level_13016 = temp__5802__auto___13015;
var _STAR_print_level_STAR__orig_val__12946_13017 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12947_13018 = managed_print_level_13016;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12947_13018);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12942_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12942_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12946_13017);
}} else {
job_fn();
}
