...
var i_17212 = (self__.level + (1));
while(true){
if((i_17212 <= (new_level + (1)))){
(update[i_17212] = self__.header);

var G__17213 = (i_17212 + (1));
i_17212 = G__17213;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_17215 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17215[i]));
} else {
x__$2.forward.push((((i < links_17215.length))?(links_17215[i]):null));
}

if((i < links_17215.length)){
(links_17215[i] = x__$2);
} else {
links_17215.push(x__$2);
}
...
var i_17219 = (0);
while(true){
if((i_17219 <= self__.level)){
var links_17220 = (update[i_17219]).forward;
if((x__$1 === (((i_17219 < links_17220.length))?(links_17220[i_17219]):null))){
(links_17220[i_17219] = (x__$1.forward[i_17219]));

var G__17222 = (i_17219 + (1));
i_17219 = G__17222;
continue;
} else {
var G__17223 = (i_17219 + (1));
i_17219 = G__17223;
continue;
}
} else {
...
var G__17225 = nx;
var G__17226 = (level__$1 - (1));
x = G__17225;
level__$1 = G__17226;
continue;
} else {
var G__17227 = x;
var G__17228 = (level__$1 - (1));
x = G__17227;
level__$1 = G__17228;
continue;
}
