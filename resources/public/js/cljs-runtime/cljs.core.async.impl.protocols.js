...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15588 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15588(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15600 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15600(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15601 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15601(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15603 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15603(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15604 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15604(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15605 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15605(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_15606 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_15606(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15608 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15608(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15609 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15609(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15610 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15610(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15611 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15611(b);
}
});
