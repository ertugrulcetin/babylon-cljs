...
}catch (e15221){var _e__12188__auto__ = e15221;
return false;
...
}catch (e15232){var _e__12188__auto__ = e15232;
return false;
...
}catch (e15246){var _e__12188__auto__ = e15246;
return false;
...
}catch (e15248){var _e__12188__auto__ = e15248;
return false;
...
}catch (e15257){var _e__12188__auto__ = e15257;
return false;
}})())){
...
}catch (e15259){var _e__12188__auto__ = e15259;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__15270 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__15271 = (function (){var or__5045__auto__ = config;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__15271);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__15270);
}});
});
...
while (G__15331__i < G__15331__a.length) {G__15331__a[G__15331__i] = arguments[G__15331__i + 0]; ++G__15331__i;}
  args = new cljs.core.IndexedSeq(G__15331__a,0,null);
} 
