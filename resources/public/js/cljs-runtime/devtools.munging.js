...
var o12505 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12505["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12506 = temp__5802__auto____$1;
return (o12506["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12151__auto__ = f;
return (o__12151__auto__["toString"]).call(o__12151__auto__);
} else {
return "";
}
}catch (e12509){var _ = e12509;
return "";
}});
...
try{var o__12151__auto___12774 = t;
(o__12151__auto___12774["cljs$lang$ctorPrWriter"]).call(o__12151__auto___12774,t,writer);
}catch (e12512){var __12775 = e12512;
}
...
var char_code = (function (){var o__12151__auto__ = (new String(char$));
return (o__12151__auto__["charCodeAt"]).call(o__12151__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12151__auto__ = String;
return (o__12151__auto__["fromCharCode"]).call(o__12151__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12529 = num_code;
switch (G__12529) {
case (1):
return (185);
...
var o__12151__auto__ = String;
return (o__12151__auto__["fromCharCode"]).call(o__12151__auto__,superscript_code);
});
/**
...
}catch (e12541){var _e__12188__auto__ = e12541;
return false;
}})())){
...
var vec__12542 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12542,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12565){
var vec__12566 = p__12565;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12566,(0),null);
...
var G__12787 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12788 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12787;
remaining_tokens = G__12788;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12560){
...
var vec__12583 = cljs.core.split_with((function (p1__12578_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12578_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12583,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12583,(1),null);
...
var vec__12599 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12599,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12599,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12795 = cljs.core.rest(remaining_tokens);
var G__12796 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12795;
name_tokens = G__12796;
continue;
} else {
...
var vec__12616 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12616,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12616,(1),null);
var vec__12619 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12619,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12619,(1),null);
var vec__12622 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12622,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12622,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12622,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12622,(3),null);
...
var vec__12634 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12634,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12634,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12634,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12634,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12634,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12634,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12638 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12638,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12638,(1),null);
var vec__12641 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12641,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12641,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12645 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12645) : devtools.munging.parse_fn_info_deep.call(null,G__12645));
})()));
}
} else {
return fn_info;
...
var G__12813 = (arity + (1));
var G__12814 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12660){
var vec__12661 = p__12660;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12661,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12661,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12676_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12676_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12677_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12677_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___12821 = arguments.length;
var i__5770__auto___12822 = (0);
while(true){
if((i__5770__auto___12822 < len__5769__auto___12821)){
args__5775__auto__.push((arguments[i__5770__auto___12822]));

var G__12823 = (i__5770__auto___12822 + (1));
i__5770__auto___12822 = G__12823;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12689){
var vec__12690 = p__12689;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12690,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12687){
var G__12688 = cljs.core.first(seq12687);
var seq12687__$1 = cljs.core.next(seq12687);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12688,seq12687__$1);
}));
...
var map__12724 = options;
var map__12724__$1 = cljs.core.__destructure_map(map__12724);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12724__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12724__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12724__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12724__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12725 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12725,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12725,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12725,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12725,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12725,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12725,(5),null);
...
var o__12151__auto__ = f;
return (o__12151__auto__["getBasis"]).call(o__12151__auto__);
});
/**
...
}catch (e12728){var _e__12188__auto__ = e12728;
...
var G__12843 = (obj[cljs.core.first(path)]);
var G__12844 = cljs.core.rest(path);
obj = G__12843;
path = G__12844;
continue;
} else {
...
var _STAR_ = (function (accum,p__12737){
var vec__12738 = p__12737;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12738,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12738,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12745){
var vec__12748 = p__12745;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12748,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12748,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12748,(2),null);
...
var post_process = (function (p__12760){
var vec__12761 = p__12760;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12761,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12761,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12755_SHARP_){
return (obj[cljs.core.first(p1__12755_SHARP_)]);
}),sorted_matches);
