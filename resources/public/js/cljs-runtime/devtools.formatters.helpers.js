...
var G__12828 = devtools.prefs.pref(v);
v = G__12828;
continue;
} else {
return v;
...
}catch (e12777){var _e__12188__auto__ = e12777;
return false;
}})();
...
}catch (e12779){var _e__12188__auto__ = e12779;
return false;
}})();
...
}catch (e12784){var _e__12188__auto__ = e12784;
return false;
}}
}
});
...
var vec__12801 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12801,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12801,(1),null);
...
return cljs.core.some((function (p1__12808_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12808_SHARP_);
}),template);
});
